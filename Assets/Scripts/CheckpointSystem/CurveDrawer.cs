...
namespace CheckpointSystem
{
    public static class CurveDrawer
    {
        ...
        private static void DrawLineBetweenCheckpointsByIndex(List<Checkpoint> checkpoints, int index1, int index2)
        {
            ...
            var splineLength = spline.Spline.Count;

            for (var j = splineLength; j < 2; j++) spline.Spline.Add(new BezierKnot(float3.zero));
            ...
            var lastKnotIndex = spline.Spline.ToArray().Length - 1;
